    ...
    <div class="container">
        <div class="login">
            ...
            <div class="login__links">
                ...
                <nuxt-link to="/register" class="login-links__item">
                    Регистрация
                </nuxt-link>
            </div>
            <form class="form" @submit.prevent="submit">
                <div class="form-inputs__wrapper">
                    <div class="form-input__wrapper">
                        <input v-model="form.email" class="form-item__input" type="text" id="email" required autofocus>
                        <label for="email" class="form-item__label">E-mail</label>
                    </div>
                    <div class="form-input__wrapper">
                        <input v-model="form.password" class="form-item__input" type="password" id="password" required>
