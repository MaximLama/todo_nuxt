...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"frontend","htmlAttrs":{"lang":"ru"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"script":[{"src":"https:\u002F\u002Fcode.jquery.com\u002Fjquery-3.7.1.min.js","type":"text\u002Fjavascript","integrity":"sha256-\u002FJqT3SQfawRcv\u002FBIHPThkBvs0OEvtFFmqPF\u002FlYI\u002FCxo=","crossorigin":"anonymous"}],"style":[]},
  ...
  if (typeof nuxt_plugin_plugin_78aa985c === 'function') {
    await nuxt_plugin_plugin_78aa985c(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_48ed251c === 'function') {
    await nuxt_plugin_axios_48ed251c(app.context, inject)
  }

  if (typeof nuxt_plugin_user_94a8ff7a === 'function') {
  ...
  if (typeof nuxt_plugin_auth_449dc57e === 'function') {
    await nuxt_plugin_auth_449dc57e(app.context, inject)
  }
